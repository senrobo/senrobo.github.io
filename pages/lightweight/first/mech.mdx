...
During the building process, we initially hoped to utilize our senior's tried-and-true method of fabiracting a aluminium mirror. However, upon further analysis, we quickly realized that this approach would be prohibitively weight expensive and we scrapped the idea.
